...
public enum BaseResponseStatus {
    ...
    EMPTY_DATE(false, 2015, "날짜을 입력해주세요."),
    EMPTY_CONTENT(false, 2016, "내용을 입력해주세요."),
    EMPTY_D_DAY_TYPE(false, 3017, "디데이 구분을 입력해주세요."),
    EMPTY_EMOTION(false, 2018, "감정 이모티콘 URL 입력해주세요."),
