...
public enum BaseResponseStatus {
    ...
    EMPTY_DISTINCTION(false, 2000, "구분을 입력해주세요."),
    ...
    NOT_FOUND_VACATION(false, 3005, "존재하지 않는 휴가입니다."),
    FAILED_TO_POST_VACATION(false, 3007, "휴가 등록에 실패하였습니다."),
    FAILED_TO_PATCH_VACATION(false, 3007, "휴가 변경에 실패하였습니다."),
    FAILED_TO_DELETE_VACATION(false, 3007, "휴가 삭제에 실패하였습니다."),
    FAILED_TO_GET_VACATION(false, 3007, "휴가 조회에 실패하였습니다."),
    FAILED_TO_PUSH_MESSAGE(false, 3007, "스케줄러, PUSH 메시지 발송에 실패하였습니다."),
