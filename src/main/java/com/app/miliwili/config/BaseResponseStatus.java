...
public enum BaseResponseStatus {
    ...
    EMPTY_ALL(false, 2008, "입력된 값이 없습니다. 값을 입력해주세요."),
    EMPTY_COLOR(false, 2009, "색상을 입력해주세요."),
    EMPTY_PLAN_TYPE(false, 2010, "일정 타입을 입력해주세요."),
    EMPTY_CALENDAR_START_DATE(false, 2011, "시작날짜을 입력해주세요."),
    EMPTY_CALENDAR_END_DATE(false, 2012, "종료날짜을 입력해주세요."),
    EMPTY_PUSH_DEVICE_TOKEN(false, 2013, "PUSH 디바이스 토큰을 입력해주세요."),
    INVALID_ORDINARY_LEAVE_START_DATE(false, 2014, "휴가시작일 형식을 확인해주세요."),
    INVALID_ORDINARY_LEAVE_END_DATE(false, 2015, "휴가종료일 형식을 확인해주세요."),
    INVALID_BIRTHDAY(false, 2016, "생일 형식을 확인해주세요."),
    INVALID_CALENDAR_START_DATE(false, 2017, "시작날짜 형식을 확인해주세요."),
    INVALID_CALENDAR_END_DATE(false, 2018, "종료날짜 형식을 확인해주세요."),
    EXCEED_MAX20(false, 2019, "입력할 수 있는 최대 20글자의 수를 초과하였습니다."),
    EXCEED_MAX25(false, 2020, "입력할 수 있는 최대 25글자의 수를 초과하였습니다."),
    NOT_BE_GREATER_THAN_TOTAL_DAYS(false, 2021, "사용일은 총 휴가일수를 초과할 수 없습니다."),
    ...
    OUT_OF_BOUNDS_DATE_DIARY(false, 3022, "다이어리를 작성할 수 있는 범위를 벗어났습니다."),
    ALREADY_EXIST_DIARY(false, 3023, "이미 해당 날짜에는 다이어리가 존재합니다."),
    NOT_FOUND_DIARY(false, 3024, "존재하지 않는 다이어리입니다."),
    FAILED_TO_POST_DIARY(false, 3025, "다이어리 생성에 실패하였습니다."),
    FAILED_TO_PATCH_DIARY(false, 3026, "다이어리 수정에 실패하였습니다."),
    FAILED_TO_DELETE_DIARY(false, 3027, "다이어리 삭제에 실패하였습니다."),
    FAILED_TO_GET_DIARY(false, 3028, "다이어리 조회에 실패하였습니다."),
